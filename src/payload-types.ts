...
export interface Page {
  ...
  /**
   * Optional description text below the title on the page banner
   */
...
export interface News {
  ...
  status: 'draft' | 'published';
  /**
   * Optional content blocks for the article page
   */
  layout?:
    | (
        | {
...
export interface JobApplication {
  ...
  phone?: string | null;
  /**
   * The software or IT service the user is requesting access to
   */
  jobTitle: string;
  /**
   * Whether this is a software access request or an IT service request
   */
  requestType: 'software' | 'it-service';
  /**
...
/**
 * University-licensed software catalog
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Software {
  id: number;
  /**
   * Software name (e.g. "Turnitin", "MATLAB", "Adobe Creative Cloud")
   */
  name: string;
  /**
   * Software category for filtering
   */
  category:
  ...
  description: string;
  /**
   * Select a Lucide icon for the card
   */
  icon?: string | null;
  /**
   * Number of users (e.g. "1,309", "74,000+", "Site Licence")
   */
  users?: string | null;
  /**
   * Number of submissions if applicable (e.g. "33,750"). Leave empty if N/A.
   */
  submissions?: string | null;
  /**
   * Number of licenses (e.g. "100", "Site Licence", "Campus Agreement")
   */
  ...
  /**
   * License validity period (e.g. "3", "5", "Perpetual")
   */
  validityYears?: string | null;
  /**
   * Departments or people the software is issued to
   */
  ...
  status: 'active' | 'expired' | 'comingSoon';
  /**
   * Show this software prominently
   */
  featured?: boolean | null;
  /**
...
export interface Project {
  ...
  title: string;
  description: string;
  status: 'ongoing' | 'active' | 'live' | 'completed' | 'planned';
  /**
   * Progress percentage (0-100)
   */
  progress?: number | null;
...
export interface Training {
  ...
  /**
   * e.g. "Faculty", "Administrative Staff", "Students & Faculty"
   */
  audience: string;
...
export interface TeamPage {
  ...
  pageTitle: {
    ...
    title: string;
    /**
     * Small badge text above title (e.g. "MEET THE TEAM")
     */
    eyebrow?: string | null;
    /**
  ...
  slug: string;
  /**
   * Add blocks including Team Grid with member profiles
   */
  layout?:
    | (
        | {
